...
layout_rh_offsets = [0.0, 0.0, 0.0, -9.0, 9.0, -6.0];  // tbd; RH1-3 on the centreline; RH4 / RH5 the little finger's side-by-side pair, centred as LH4 / LH5; RH6 the single key below it, offset toward the player's right (the recorder's direction). The offset amount is a placeholder
