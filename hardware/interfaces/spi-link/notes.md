# SPI link — consolidation record

**Past tense only, and no live value.** Every live value is in
[`spi-link.md`](spi-link.md), in the pages it was assembled from, or in
...
described twice — once in `hardware/carrier/carrier.md` §4 and once in
